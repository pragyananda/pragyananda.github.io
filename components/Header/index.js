              ...
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  ...
                  {showResume && (
                    <Button
                      onClick={() =>
                        window.open("mailto:pragyanandasaho@gmail.com")
                      }
                    >
                      Resume
                    </Button>
                  ...
                  <Button
                    onClick={() => window.open("mailto:pragyanandasaho@gmail.com")}
                  >
                    Contact
                  </Button>
                </div>
      ...
      >
        ...
        {!isBlog ? (
          <div className="flex">
            ...
            <Button onClick={() => window.open("mailto:pragyanandasaho@gmail.com")}>
              Contact
            </Button>
